...
menuItem8 = MenuItem(user_id=1, name="Veggie Burger",
                     description="""Made with freshest of
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description="""A famous duck dish from Beijing[1] that has
                                    been prepared since the imperial
                                    era. The meat
                                    is prized for its thin,
                                    crisp skin, with authentic
                                    versions of the dish serving mostly
                                    the skin and little meat,
                                    sliced in front of the diners by
                                    the cook""",
...
menuItem6 = MenuItem(user_id=1, name="Ramen",
                     description="""a Japanese noodle soup dish. It
                                    consists of Chinese-style
                                    wheat noodles served in a
                                    meat- or (occasionally) fish-based broth,
                                    often flavored with soy
                                    sauce or miso, and uses toppings
                                    such as sliced pork,
                                    dried seaweed, kamaboko,
                                    and green onions.""",
                     price="12", course="Entree", restaurant=restaurant2)
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     description="""a Vietnamese noodle soup
                                    ...
                                    rice noodles called banh
                                    pho, a few herbs, and meat.""",
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings",
                     description="""a common Chinese
                                    dumpling which generally consists of
                                    minced meat and finely chopped vegetables
                                    wrapped into a piece of dough skin.
                                    The skin can be either thin
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     description="""Milk snow layered with
                                    honey boba, jasmine tea jelly, grass jelly,
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     description="""Golden fried cauliflower florets
                                    in a midly spiced soya,garlic sauce
                                    cooked with fresh cilantro, celery,
                                    chilies,ginger & green onions""",
...
menuItem4 = MenuItem(user_id=1, name="""Choc Full O\' Mint
                                        (Smitten\'s Fresh Mint
                                        Chip ice cream)""",
...
menuItem1 = MenuItem(user_id=1, name="Boysenberry Sorbet",
                     description="""An unsettlingly huge
                                    amount of ripe berries turned into
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     description="""Chicken marinated in yoghurt
                                    and seasoned with a spicy mix
                                    (chilli, tamarind among others)
...
menuItem10 = MenuItem(user_id=1, name="Spinach Ice Cream",
                      description="""vanilla ice cream made
                                     with organic spinach leaves""",
...
menuItem1 = MenuItem(user_id=1, name="Guanciale Chawanmushi",
                     description="""Japanese egg custard served hot with
                                    spicey Italian Pork Jowl (guanciale)""",
...
menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                     description="""Lemon Curd Ice Cream Sandwich on a
                                    chocolate macaron with cardamom
                                    meringue and cashews""",
